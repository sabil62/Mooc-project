...
class MiddleContent extends Component {
  state = {
    ...
    weekONEE: [
      ...
      {
        images: Video,
        title: "Helping People with Disabilities",
        totals: 4,
      },

      {
        picture: Video,
        images: "Byron Yu: Brain Computer Helping People with Disabilities",
      },
      {
        images: Video,
        title: " 'See' Facebook by Artificial Intelligence",
        totals: 4,
      },

      {
        images: Earth,
        title: "or Better Interface Design",
        totals: 4,
      },
      {
        images: Earth,
        title: "escriptive headaings",
        totals: 4,
      },
      {
        images: Earth,
      ...
      },
      {
        ...
        title: (
          <span>
            ...
            <br />
            THis feedback will not be public, you can send your feedback a tany
            time to the instructor without any hesitation! imagesn
          </span>
        ),
        totals: 3,
      },
